...
//    func testUnban() {
//        FlappyAPI(endpoint: "unban").unban(username, password, FlappyAPI(endpoint: "getID").getUserID("Frog")!)
//    }
//
//    func testRestoreScore() {
//        FlappyAPI(endpoint: "restoreScore").restoreScore(username, password, FlappyAPI(endpoint: "getID").getUserID("Frog")!, 0)
//    }
